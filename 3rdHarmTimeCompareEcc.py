...
ax1 = plt.subplot(111)
pylab.subplots_adjust(left=0.15, bottom=0.35)
...
pylab.xlabel('M [rad]')
pylab.ylabel('Dot Diff Btwn 2nd $&$ 3rd Harm. [m s$^{-1}$]')

pylab.xlim([0,2.0*np.pi])
pylab.ylim([-250,250])

axcolor = 'lightgoldenrodyellow'
axKA = pylab.axes([0.15, 0.08, 0.65, 0.03], axisbg=axcolor)
axoA = pylab.axes([0.15, 0.13, 0.65, 0.03], axisbg=axcolor)
axeA = pylab.axes([0.15, 0.23, 0.65, 0.03], axisbg=axcolor)
axeB = pylab.axes([0.15, 0.18, 0.65, 0.03], axisbg=axcolor)
